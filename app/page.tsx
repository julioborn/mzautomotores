        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-24 sm:h-32">
              ...
              {user ? (
                <>
                  ...
                  <Button
                    ...
                    className="border-slate-300 text-slate-600 hover:text-slate-800 hover:bg-slate-50 bg-transparent"
                  >
            ...
            <div className="sm:hidden flex items-center gap-2">
              <Link href="/contact" prefetch={true}>
                <Button size="sm" variant="ghost" className="text-slate-600 hover:text-slate-800 hover:bg-slate-100">
                  Contacto
                </Button>
              </Link>
              {user ? (
                <>
                  <Link href="/admin" prefetch={true}>
                    <Button
                      size="sm"
                      className="bg-gradient-to-r from-slate-800 to-slate-700 hover:from-slate-700 hover:to-slate-600 text-white text-xs px-2"
                    >
                      Admin
                    </Button>
                  </Link>
                  <Button
                    ...
                    variant="outline"
                    onClick={handleLogout}
                    className="border-slate-300 text-slate-600 hover:text-slate-800 hover:bg-slate-50 text-xs px-2 bg-transparent"
                  >
